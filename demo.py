...
import mujoco
import numpy as np
xml_path = "mujoco_menagerie/franka_emika_panda/my_scene.xml"
...
class Demo:
    ...
    def gripper(self, open=True):
        self.data.actuator("actuator8").ctrl = (0, 10)[not open]
    ...
    def control(self, xpos_d, xquat_d):
        ...
        bodyid = mujoco.mj_name2id(self.model, mujoco.mjtObj.mjOBJ_BODY, "hand")
